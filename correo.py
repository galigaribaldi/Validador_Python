...
def enviar_correo(correo_destinatario, cuerpo2, asunto2):
    remitente = 'galigaribaldi70@gmail.com'
    destinatarios = []
    ...
    sesion_smtp.login('galigaribaldi70@gmail.com','TbBk.py70')
...
def enviar_correo_PDF(correo_destinatario, asunto,nombre_PDF):
    remitente = 'galigaribaldi70@gmail.com'
    destinatarios = []
    destinatarios.append(correo_destinatario)
    asunto = asunto
    cuerpo = "Hola, este es un correo Automático generado para mandar calificaciones."
